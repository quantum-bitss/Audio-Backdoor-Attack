...
class smallcnn(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = nn.Linear(in_features=3072,out_features=128)  #256,3072 ultrasonic   224 flowmur
...
#class model_trojaning_attacks(nn.Module):
    def __init__(self, num_classes):
        ...
        self.fc1 = nn.Linear(in_features=12288,out_features=256)      #sample_rate=16000，256，1，32，13 flowmur 768 ultrasonic 12288
...
class lstmwithattention(nn.Module):
    def __init__(self, classes):
        ...
        self.rnn1 = nn.LSTM(input_size=40, hidden_size=64, bidirectional=True, batch_first=True)
        self.rnn2 = nn.LSTM(input_size=128, hidden_size=64, bidirectional=True, batch_first=True)

        self.dense1 = nn.Linear(128, 128)
        self.attention = nn.Linear(128, 128)
        self.dense2 = nn.Linear(100, 64) # ultrasonic 100 jingleback 101
...
class RNN(nn.Module):
    def __init__(self, num_classes):
        ...
        self.num_layers = 3
        self.lstm = nn.LSTM(40, 768, 3, batch_first=True)
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=10):
        ...
        self.fc = nn.Linear(384, num_classes)         # ultrasonic 384   flowmur 64
